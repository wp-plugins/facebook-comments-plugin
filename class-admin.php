...
<?php } ?>
				<tr valign="top"><th scope="row"><label for="jquery">Enable jQuery</label></th>
					<td><input id="jquery" name="fbcomments[jquery]" type="checkbox" value="on" <?php checked('on', $options['jquery']); ?> /> <small>only enable this if you don't have jQuery enabled. This loads 1.7.2 from Google</small></td>
				</tr>
